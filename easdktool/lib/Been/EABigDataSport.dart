...
/// 室内跑步
/// Indoor Running
const kEASportTypeIdRunning = 127;

/// 户外健走
/// Fast Walking
const kEASportTypeFastWalking = 128;

/// 室内健走
/// Indoor walking
const kEASportTypeIdWalking = 129;

/// 小轮车
/// BMX
const kEASportTypeBmx = 130;

/// 有氧训练
/// Aerobic Training
const kEASportTypeAerobicTraining = 131;

/// 无氧训练
/// Anaerobic Training
const kEASportTypeAnaerobicTraining = 132;

/// 混合有氧
/// Mix Aerobic
const kEASportTypeMixAerobic = 133;

/// 打猎
/// Hunting
const kEASportTypeHunting = 134;

/// 遛狗
/// Walk the Dog
const kEASportTypeWalkTheDog = 135;

/// 蹦极跳
/// Bungee Jumping
const kEASportTypeBungeeJumping = 136;

/// 摩托艇
/// MotorBoat
const kEASportTypeMotorBoat = 137;

/// 户外溜冰
/// Outdoor Ice Skating
const kEASportTypeOutdoorIceSkating = 138;

/// 室内溜冰
/// Indoor Ice Skating
const kEASportTypeIndoorIceSkating = 139;

/// 冬季两项
///  Biathlon *
const kEASportTypeBiathlon = 140;

/// 门球
/// Croquet
const kEASportTypeCroquet = 141;

/// 沙滩排球
/// Volleyball
const kEASportTypeVolleyball = 142;

/// 躲避球
/// Dodge Ball
const kEASportTypeDodgeBall = 143;

/// 美式足球
/// Football
const kEASportTypeAmericanFootball = 144;

/// 交谊舞
/// Social Dancing
const kEASportTypeSocialDancing = 145;

/// 尊巴
/// Zumba
const kEASportTypeZumba = 146;

/// 迪斯科
/// Disco
const kEASportTypeDisco = 147;

/// 华尔兹
/// Waltz
const kEASportTypeWaltz = 148;
...
/// 探戈
/// Tango
const kEASportTypeTango = 150;

/// 踢踏舞
/// Tap Dance
const kEASportTypeTapDance = 151;

/// 障碍赛
/// Show Jumper
const kEASportTypeShowJumper = 152;

/// 攀爬 :
/// climbing
const kEASportTypeClimbing = 153;

/// 冲浪 :
/// Surfing
const kEASportTypeWaterSurfing = 154;

/// 广场舞 :
/// Square Dancing
const kEASportTypeSquareDancing = 155;

/// 高山滑雪 :
/// Alpine Skiing
const kEASportTypeDownhillskiing = 156;

/// 竞走 */
const kEASportTypeWalkingRace = 157;

/// 室内冲浪 */
const kEASportTypeIndoorSurfing = 158;

/// 战绳 */
const kEASportTypeBattleRope = 159;

/// 室内健身 */
const kEASportTypeIndoorFitness = 160;

/// 越野摩托 */
const kEASportTypeScramblingMotorcycle = 161;

/// 回力球 */
const kEASportTypeHiliBall = 162;

/// 钢管舞 */
const kEASportTypePoleDancing = 163;

/// 现代舞 */
const kEASportTypeModernDance = 164;

/// 桌上足球 */
const kEASportTypeTableFootball = 165;

/// 秋千 */
const kEASportTypeSwing = 166;

/// 踢毽子 */
const kEASportTypeShuttlecockKicking = 167;

/// 室内溜冰 */
const kEASportTypeIndoorSkatingRink = 168;

/// 马拉松赛跑  Marathon */
const kEASportTypeMarathon = 169;

/// 平衡训练    Balance */
const kEASportTypeBalance = 170;

/// 深蹲          Squats */
const kEASportTypeSquats = 171;

/// 背包旅行    Backpacking */
const kEASportTypeBackpacking = 172;

/// 铁饼          Discus */
const kEASportTypeDiscus = 173;

/// 标枪          Javelin Throw */
const kEASportTypeJavelinThrow = 174;

/// 滑板车      Scooter */
const kEASportTypeScooter = 175;

/// 水上自行车  Water Biking */
const kEASportTypeWaterBiking = 176;

/// 双打网球      Doubles Tennis */
const kEASportTypeDoublesTennis = 177;

/// 草地曲棍球  Field Hockey */
const kEASportTypeFieldHockey = 178;

/// 链球          Hammer Throw */
const kEASportTypeHammerThrow = 179;

/// 铅球            Shot Put */
const kEASportTypeShotPut = 180;

/// 舞蹈扶手杠  Barre */
const kEASportTypeBarre = 181;

/// 霹雳舞      Break Dance */
const kEASportTypeBreakDance = 182;

/// 肢体格斗       Body Combat */
const kEASportTypeBodyCombat = 183;

/// 踢拳           Kickboxing */
const kEASportTypeKickboxing = 184;

/// 花式骑术    Dressage */
const kEASportTypeDressage = 185;

/// 悬挂训练      Trx */
const kEASportTypeTrx = 186;

/// 滑水        Water Skiing */
const kEASportTypeWaterSkiing = 187;
