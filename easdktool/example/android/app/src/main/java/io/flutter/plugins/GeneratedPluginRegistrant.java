...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.easdktool.EasdktoolPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin easdktool, com.example.easdktool.EasdktoolPlugin", e);
    }
    try {
